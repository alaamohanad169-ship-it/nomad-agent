"""Nomad agent — battery-aware, tool-using AI agent."""
import asyncio
import json
import time
import uuid
...
class NomadAgent:
    """Main Nomad agent with tool support and battery awareness."""
    ...
    def _build_messages(self, user_message: str, battery) -> list[dict]:
        ...
        # System prompt
        system_parts = [
            "You are Nomad, a mobile-first AI assistant with access to tools.",
        ...
        for attempt in range(3):
            async with httpx.AsyncClient(timeout=60) as client:
                ...
                if content:
                    ...
                    result["content"] = message["reasoning"]
